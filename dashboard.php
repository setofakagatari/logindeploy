...
<html>
	...
	<body>
		<div class="contenedor">
			...
			<div class="text">
			<p>
				Nuestra pagina web permite actualizar sus datos personales, tal como puede ver en la esquina superior derecha
				y tambien permite modificar las tablas de ventas, empleados, servicios, compras y articulos, esto lo puede encontrar en la parte inferior de la pagina.
